...
function cartNumbers(product, action) {
    ...
    console.log("test that action is running correctly");
        ...
        console.log("test that productNumbers variable has incremented correctly");
...
function setItems(product) { //Matches each cart item clicked with appropraite object in products array 
...
function manageQuantity() {
    ...
    let decreaseButtons = document.querySelector('.decrease'); // gets decrease item button on screen and stores in variable

    let increaseButtons = document.querySelector('.increase');
    ...
    for(let i=0; i < increaseButtons.length; i++) { // Runs a for loop that either increases or decreases quantity of items
        ...
        decreaseButtons[i].addEventListener('click', () => { // decreases quantity of items on button click
            ...
            console.log(currentQuantity, "updated quantity");
            
            currentProduct = decreaseButtons[i].parentElement.previousElementSibling
            .previousElementSibling.querySelector('.span').textContent.toLocaleLowerCase()
            .replace(/ /g,'').trim();
            console.log(currentProduct, "updated currentProduct variable");
...
function deleteButtons() {
    ...
    for(let i=0; i < deleteButtons.length; i++) {
        ...
        deleteButtons[i].addEventListener('click', () => {
            ...
            productName = deleteButtons[i].parentElement.textContent.toLocaleLowerCase()
            .replace(/ /g,'').trim();
